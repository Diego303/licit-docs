...
description: "Enums, dataclasses y schemas Pydantic usados internamente."
order: 11
---
...
Los modelos de configuración están documentados en detalle en la [Guía de configuración](../configuration/). Aquí se lista la jerarquía:
