...
description: "Legal context of the EU AI Act, OWASP, NIST, ISO with references to official texts."
order: 9
---
...
- [Regulation (EU) 2024/1689 — EUR-Lex](https://eur-lex.europa.eu/legal-content/ES/TXT/?uri=CELEX:32024R1689)
...
4. **Compliance percentages are indicative.** An "80% compliant" does not mean legal compliance — a single unfulfilled article can have regulatory consequences.
5. **Auto-detection is heuristic-based.** Auto-detected answers in the FRIA are suggestions based on technical signals, not legal determinations.
