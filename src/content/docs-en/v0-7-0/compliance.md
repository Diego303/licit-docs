...
- **Transparency**: Is AI usage properly documented?
...
The EU AI Act is the first comprehensive regulatory framework for artificial intelligence. It entered into force in August 2024, with phased enforcement through August 2027.
...
| Art. 13(1) | Transparency | Annex IV, config changelog, requirements traceability |
...
The OWASP Top 10 for Agentic AI Security identifies the top 10 security risks in applications using AI agents. licit evaluates the project's posture against each risk with numeric scoring.
...
Each OWASP risk maps to collectible evidence from `ProjectContext` and `EvidenceBundle`:
...
| Architect reports | Audit trail, guardrails, quality gates, budget | **Functional** (v0.7.0) |
| SARIF files | Security findings (vulnerabilities) | **Functional** (v0.7.0) |
