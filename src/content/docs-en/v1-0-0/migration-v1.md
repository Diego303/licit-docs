...
> **Status**: V1.0.0 has been released. Changes from V0 → V1 are detailed in [CHANGELOG.md](../CHANGELOG.md). This document documents the stability contract and the changes made.
...
5. **Sigstore integration** — `provenance.sign` could support keyless signing in addition to HMAC.
...
- **Evidence**: Will reuse existing `EvidenceBundle` + new fields for advanced data governance
