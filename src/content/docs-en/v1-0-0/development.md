...
All Phase 1-7 modules use direct imports — there are no `type: ignore` annotations in any module.
...
Each phase has its detailed section in the [implementation plan](../Licit_V0_Plan_Implementacion.md).
