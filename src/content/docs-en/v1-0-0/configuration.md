---
title: "Configuration"
description: "Configuration guide for .licit.yaml with all fields for licit v1.0.0."
order: 4
---
...
| Field | Type | Default | Description |
|---|---|---|---|
| `eu_ai_act` | bool | `true` | EU AI Act (EU Regulation 2024/1689) |
...
| `config_path` | str? | `null` | Path to architect YAML config |
...
| Audit log | JSONL (`audit_log`) | Audit trail (additional entries to count) |
...
| Field | Type | Default | Description |
|---|---|---|---|
| `output_dir` | str | `.licit/reports` | Output directory for reports (respected by `licit report`) |
