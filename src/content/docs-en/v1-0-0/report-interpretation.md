...
description: "How to read and act on compliance and gap analysis reports."
order: 10
---
...
| Field | Meaning |
|---|---|
| Compliance rate | `compliant / (compliant + partial + non_compliant) * 100`. Excludes N/A and not-evaluated |
...
|---|---|---|
| 80-100% | Strong compliance posture | Maintain and monitor |
...
| 0-19% | Minimal compliance — typical of newly initialized project | Run `licit fria`, `licit annex-iv`, `licit trace` |
...
| Art. 10 | Data governance | Always PARTIAL (deployer doesn't train) — document provider practices |
...
| Annex IV | Technical docs | `licit annex-iv` |
...
| ASI08 | Unlimited consumption | Budget limits in architect |
...
| high | 1-3 days | Configure vigil/semgrep, implement sandboxing, configure budget limits |
