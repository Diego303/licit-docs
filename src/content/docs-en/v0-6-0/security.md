...
|---|---|---|
| Provenance store manipulation | High | HMAC-SHA256 signing, Merkle tree for integrity |
...
| Contributor info exposure | Low | Provenance is not pushed by default; recommendation in `.gitignore` |
...
- SHA256 is calculated for each record, forming the tree leaves
