...
The FRIA (Fundamental Rights Impact Assessment) is a mandatory assessment under **Article 27 of the EU AI Act**. Before putting an AI system into use, the deployer must assess its impact on fundamental rights.
...
| No | High risk. You must justify why it is acceptable and what alternative mitigations exist |
...
- Tokens/credentials (although they should not be there)
...
| Possibly | Unclear — the AI agent could generate code that processes data |
...
| Medium risk — user-facing | The software has users but does not handle critical data |
| High risk — financial/health/identity | The software handles money, health, or personal identity |
...
> **Objective:** Assess the likelihood and severity of impact on identified rights.
...
- "Professional liability insurance for software products"
...
|---|---|
| Quarterly | High risk, frequent changes to the system |
...
| `.licit/fria-report.md` | Formatted Markdown report. **Do version** — this is the regulatory document |
...
- When the AI model in use changes
