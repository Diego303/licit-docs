...
All modules from Phases 1-6 use direct imports. Only connectors (Phase 7) would use lazy imports when implemented:
...
> **Note**: Modules from Phases 2-6 (provenance, changelog, eu_ai_act, owasp_agentic, reports) are imported directly without `type: ignore`.
