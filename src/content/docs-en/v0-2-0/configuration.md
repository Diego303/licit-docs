...
licit uses a YAML file called `.licit.yaml` at the project root. It is generated automatically with `licit init` but can be edited manually.
...
provenance:
  ...
  confidence_threshold: 0.6  # Minimum threshold for AI classification
...
- `git-ai`: Reads annotations from git-ai-like tools (planned).
