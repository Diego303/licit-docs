...
description: "Recommendations for effectively integrating licit into your AI development workflow."
order: 10
---
...
### 18. Keep the Configuration Updated
...
| Antipattern | Why it is problematic | What to do instead |
|---|---|---|
| Ignoring `licit verify` warnings | Partials accumulate | Treat partials as technical debt |
| Not version-controlling `.licit.yaml` | Each dev uses different config | Commit to repo |
| Uploading `provenance.jsonl` to a public repo | Exposes contributor info | Add to `.gitignore` |
