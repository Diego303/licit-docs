---
title: "Introduction"
description: "Main documentation for licit v0.3.0, a CLI tool for regulatory compliance and code traceability for AI-assisted development teams."
order: 1
---
...
- **v0.3.0** — Phase 1 (Foundation) + Phase 2 (Provenance) + Phase 3 (Changelog) completed
- Python 3.12+ required
- 10 CLI commands registered, 5 functional (`init`, `status`, `connect`, `trace`, `changelog`)
