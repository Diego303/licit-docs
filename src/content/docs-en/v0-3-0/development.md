...
### 1. Pydantic for configuration only
...
> **Note**: Phase 2 (provenance) and Phase 3 (changelog) modules are already implemented and are imported directly without `type: ignore`.
