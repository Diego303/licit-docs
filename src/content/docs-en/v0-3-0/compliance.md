...
The EU AI Act is the first comprehensive regulatory framework for artificial intelligence. It came into force in August 2024, with gradual enforcement through August 2027.
...
| Art. 13 | Transparency | AI usage disclosure, provenance tracking |
...
2. **Identification of affected rights**: What fundamental rights could be impacted.
...
The OWASP Agentic Top 10 identifies the 10 main security risks in applications using AI agents. licit evaluates the project's posture against each risk.
...
| Agent config changelog | Agent config changes with severity | **Functional** (v0.3.0) |
...
| `.licit/` data | FRIA, Annex IV, changelog, provenance store | Partial (provenance + changelog functional) |
...
| **SOC 2 AI** | Considered | AI-specific SOC 2 controls |
| **IEEE 7000** | Considered | Ethical system design |
