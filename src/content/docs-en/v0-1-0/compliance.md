---
title: "Compliance"
description: "Supported regulatory frameworks including EU AI Act and OWASP Agentic Top 10, and how licit evaluates compliance."
order: 6
---
...
- **Transparency**: Is the use of AI adequately documented?
...
| Art. 26 | Obligations of Deployers | Compliant usage, monitoring, activity logging |
...
3. **Risk assessment**: Likelihood and impact of each risk.
...
|---|---|
| Git history | Code provenance, contributors, frequency |
| Agent configs | Guardrails, models used, code rules |
| CI/CD configs | Human review gates, security steps |
| Architect reports | Audit trail, execution quality |
| SARIF files | Security findings (vulnerabilities) |
...
|---|---|---|
| **NIST AI RMF** | Planned (V1) | NIST AI Risk Management Framework |
