...
4. If architect or vigil are detected, their connectors are automatically enabled.
...
| Option | Default | Description |
|---|---|---|
| `--since` | (all) | Changes from a date or tag |
...
For detailed documentation on the changelog system, see [Changelog](/licit-docs/en/docs/changelog/).
...
4. Saves data to `.licit/fria-data.json` and generates a report in `.licit/fria-report.md`.
...
- `.licit/fria-report.md` — Human-readable Markdown report of the FRIA
...
> **Status**: **Functional for EU AI Act** (Phase 4). OWASP evaluation pending (Phase 5).
...
| `trace` | 2 | **Functional** | Code provenance traceability |
...
| `verify` | 4 | **Functional (EU AI Act)** | CI/CD gate |
