...
### `licit report` / `licit gaps` do not work
...
| `verify` | 4 | **Functional** (v0.4.0) |
| `report` | 6 | Skeleton |
| `gaps` | 6 | Skeleton |

The functional commands in v0.4.0 are: `init`, `status`, `connect`, `trace`, `changelog`, `fria`, `annex-iv`, `verify`.
